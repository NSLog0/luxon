define(["exports"], function(e) {
  ...
  var l = (function(e) {
    ...
    j = { year: p, month: p, day: p, hour: p, minute: p },
    F = { year: p, month: p, day: p, hour: p, minute: p, second: p },
    Z = { year: p, month: w, day: p, hour: p, minute: p },
    ...
    q = { year: p, month: k, day: p, hour: p, minute: p, second: p, timeZoneName: w },
    H = { year: p, month: k, day: p, weekday: k, hour: p, minute: p, timeZoneName: k },
    U = { year: p, month: k, day: p, weekday: k, hour: p, minute: p, second: p, timeZoneName: k };
  function R(e) {
    return void 0 === e;
  }
  function P(e) {
  ...
  function ae(e) {
    ...
    return (
      e.year < 100 && e.year >= 0 && (t = new Date(t)).setUTCFullYear(t.getUTCFullYear() - 1900), +t
    );
  }
  function ue(e) {
      ...
      (e.create = function(t, n) {
        ...
        (e.parseFormat = function(e) {
          for (var t = null, n = "", r = !1, i = [], o = 0; o < e.length; o++) {
            var a = e.charAt(o);
            "'" === a
              ? (n.length > 0 && i.push({ literal: r, val: n }), (t = null), (n = ""), (r = !r))
              : r
                ? (n += a)
                : a === t
                  ? (n += a)
                  : (n.length > 0 && i.push({ literal: !1, val: n }), (n = a), (t = a));
          }
        ...
        if (((this.opts = n), (this.hasIntl = J()), e.zone.universal && this.hasIntl)) {
          ...
          0 !== e.offset && a
            ...
            : ((r = "UTC"),
              n.timeZoneName
                ? (this.dt = e)
                : (this.dt = 0 === e.offset ? e : sr.fromMillis(e.ts + 60 * e.offset * 1e3)));
      ...
      return (
            ...
            ot(
              ...
              function() {
                if (!t.meridiemCache) {
                  ...
                  t.meridiemCache = [sr.utc(2016, 11, 13, 9), sr.utc(2016, 11, 13, 19)].map(
                    function(n) {
        ...
        (t.eras = function(e, t) {
          ...
          return (
            ...
            ot(this, e, t, Ie, function() {
              ...
              return (
                n.eraCache[e] ||
                  (n.eraCache[e] = [sr.utc(-40, 1, 1), sr.utc(2017, 1, 1)].map(function(e) {
        ...
        (t.isEnglish = function() {
          return (
            ...
            (J() && new Intl.DateTimeFormat(this.intl).resolvedOptions().locale.startsWith("en-us"))
          );
        }),
        (t.equals = function(e) {
          return (
  ...
  var an = (function() {
    ...
    return (
      ...
      (t.set = function(t) {
        return this.isValid
          ? rn(this, { values: Object.assign(this.values, de(t, e.normalizeUnit, [])) })
          : this;
      }),
      ...
      return (
        ...
        (t.splitBy = function(t) {
          ...
          for (var r, i = this.s, o = 1, a = []; i < this.e; ) {
            ...
            (r = +u > +this.e ? this.e : u), a.push(e.fromDateTimes(i, r)), (i = r), (o += 1);
          }
          return a;
        }),
        ...
        (e.xor = function(t) {
          for (
            ...
            1 === (o += "s" === l.type ? 1 : -1)
              ? (i = l.time)
              : (i && +i != +l.time && a.push(e.fromDateTimes(i, l.time)), (i = null));
          }
          return e.merge(a);
        }),
      ...
      return (
        ...
        (e.weekdays = function(e, t) {
          ...
          var n = void 0 === t ? {} : t,
            ...
            a = void 0 === o ? null : o,
            u = n.locObj;
          return ((void 0 === u ? null : u) || ct.create(i, a, null)).weekdays(e);
        }),
        (e.weekdaysFormat = function(e, t) {
          ...
          var n = void 0 === t ? {} : t,
            ...
            a = void 0 === o ? null : o,
            u = n.locObj;
          return ((void 0 === u ? null : u) || ct.create(i, a, null)).weekdays(e, !0);
        }),
  ...
  function Vn(e, t, n) {
      ...
      h = d
        ? (function(e) {
            ...
            return (
              ...
              R(e.q) || (e.M = 3 * (e.q - 1) + 1),
              R(e.h) ||
                (e.h < 12 && 1 === e.a ? (e.h += 12) : 12 === e.h && 0 === e.a && (e.h = 0)),
              0 === e.G && e.y && (e.y = -e.y),
              R(e.u) || (e.S = te(e.u)),
              [
    ...
    return { input: t, tokens: r, regex: c, rawMatches: f, matches: d, result: y, zone: v };
  }
  ...
  function An(e) {
    ...
    return (
      u < 1 ? (u = ue((t = n - 1))) : u > ue(n) ? ((t = n + 1), (u = 1)) : (t = n),
  ...
  function Bn(e, t, n, r, i) {
    ...
    return sr.invalid(new Ce("unparsable", 'the input "' + i + "\" can't be parsed as " + r));
  }
  function Qn(e, t, n) {
    return (
      void 0 === n && (n = !0),
  ...
  function Kn(e, t) {
    ...
    (r && 0 === e.second && 0 === e.millisecond) ||
      ((y += "basic" === m ? "ss" : ":ss"), (o && 0 === e.millisecond) || (y += ".SSS")),
      (l || a) && d && (y += " "),
  ...
  var sr = (function() {
    function e(e) {
      ...
      if (!n)
        if (e.old && e.old.ts === this.ts && e.old.zone.equals(t)) {
          ...
          (r = Yn(this.ts, a)),
            (r = (n = Number.isNaN(r.year) ? new Ce("invalid input") : null) ? null : r),
            (i = n ? null : a);
        }
      (this._zone = t),
        (this.loc = e.loc || ct.create()),
    ...
    (e.now = function() {
      ...
      (e.local = function(t, n, r, i, o, a, u) {
        return R(t)
          ? e.now()
          : ar(
              { year: t, month: n, day: r, hour: i, minute: o, second: a, millisecond: u },
              Ke.defaultZone
            );
      }),
      ...
      (e.fromJSDate = function(t, n) {
        ...
        return o.isValid ? new e({ ts: i, zone: o, loc: ct.fromObject(n) }) : e.invalid(Rn(o));
      }),
      (e.fromMillis = function(t, n) {
        if ((void 0 === n && (n = {}), P(t)))
          return t < -864e13 || t > 864e13
            ? e.invalid("Timestamp out of range")
            : new e({ ts: t, zone: We(n.zone, Ke.defaultZone), loc: ct.fromObject(n) });
        throw new v(
      ...
      (e.fromSeconds = function(t, n) {
        if ((void 0 === n && (n = {}), P(t)))
          return new e({ ts: 1e3 * t, zone: We(n.zone, Ke.defaultZone), loc: ct.fromObject(n) });
      ...
      (e.fromFormat = function(t, n, r) {
        ...
        var i = r,
          ...
          })(ct.fromOpts({ locale: a, numberingSystem: s, defaultToEN: !0 }), t, n),
          l = c[0],
          f = c[1],
          d = c[2];
    ...
    return (
      ...
      (t.startOf = function(e) {
        ...
        if (("weeks" === n && (t.weekday = 7), "quarters" === n)) {
      ...
      (t.toFormat = function(e, t) {
        return (
          void 0 === t && (t = {}),
          this.isValid
            ? xe.create(this.loc.redefaultToEN(t)).formatDateTimeFromString(this, e)
            : "Invalid DateTime"
        );
      }),
      (t.toLocaleString = function(e) {
        return (
          void 0 === e && (e = b),
          this.isValid ? xe.create(this.loc.clone(e), e).formatDateTime(this) : "Invalid DateTime"
        );
      }),
      (t.toLocaleParts = function(e) {
        return (
          void 0 === e && (e = {}),
          this.isValid ? xe.create(this.loc.clone(e), e).formatDateTimeParts(this) : []
        );
      }),
      (t.toISO = function(e) {
        return (
      ...
      (t.diff = function(e, t, n) {
        if (
          ...
          return an.invalid(this.invalid || e.invalid, "created by diffing an invalid DateTime");
        var r,
      ...
      (t.diffNow = function(t, n) {
        return (
          void 0 === t && (t = "milliseconds"), void 0 === n && (n = {}), this.diff(e.now(), t, n)
        );
      }),
      (t.until = function(e) {
      ...
      (t.toRelative = function(t) {
        ...
        return (
          ...
          ur(n, this.plus(r), Object.assign(t, { numeric: "always", units: i, unit: o }))
        );
      }),
      ...
      (e.fromFormatExplain = function(e, t, n) {
        ...
        var r = n,
          ...
          a = r.numberingSystem,
          u = void 0 === a ? null : a;
        return Vn(ct.fromOpts({ locale: o, numberingSystem: u, defaultToEN: !0 }), e, t);
      }),
